      ...
      <div className="flex flex-wrap gap-2">
        {evidence.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="group relative w-16 h-16 rounded-xl border border-slate-200 bg-white overflow-hidden cursor-pointer shadow-sm transition duration-200 hover:border-slate-300 shrink-0"
